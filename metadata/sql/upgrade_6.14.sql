...
SELECT p.id, p.projecttitle, p.projectdescription, p.emailinvitetext, p.projectstatus, p.checkpoint,
p.created_on, p.updated_at, p.version, p.createdby_id, p.lastupdatedby_id, p.emailinvitesubject,
u.id AS prid, u.first_name AS prac_first_name, u.last_name AS prac_last_name, p.costcode as costcode,
u.username as prac_username, u.department as prac_department
