...
<ul>
    ...
    <li>
        <mobriz4server:label styleClass="desc" key="user.website"/>
    ...
    <li>
        ...
        <div class="group">
            ...
            <div>
                ...
                <p><mobriz4server:label key="user.address.province"/></p>
            </div>
            <div class="left">
                ...
                <p><mobriz4server:label key="user.address.postalCode"/></p>
            </div>
            <div>
                <mobriz4server:country name="address.country" prompt="" default="${user.address.country}"/>
                <p><mobriz4server:label key="user.address.country"/></p>
            </div>
        </div>
    </li>
<c:choose>
