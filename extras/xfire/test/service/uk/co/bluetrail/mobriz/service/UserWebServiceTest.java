...
public class UserWebServiceTest extends AbstractXFireSpringTest {
    ...
    public void testGetUser() throws Exception {
        ...
        // invoke webservice
        Document response =
            invokeService("UserWebService", "/uk/co/bluetrail/mobriz/service/getUser.xml");
    ...
    protected ApplicationContext createContext() {
        return new ClassPathXmlApplicationContext(new String[]{
                "uk/co/bluetrail/mobriz/service/applicationContext-test.xml",
                "uk/co/bluetrail/mobriz/service/applicationContext-webservice.xml"});
    }
