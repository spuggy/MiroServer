	...
	<xsl:template match="/html/body">
		...
		<fo:root>
			<fo:layout-master-set>
				<fo:simple-page-master master-name="noheader" page-height="29.7cm" page-width="21.0cm" margin-left="0.5cm" margin-right="0.5cm"
					>
	...
	<xsl:template match="/html/body/div[@id = '0' ]">
		<fo:page-sequence master-reference="noheader"  force-page-count="no-force">
			<fo:flow flow-name="xsl-region-body">
				<fo:block margin-left="40" padding-before="730" background-repeat="no-repeat" padding-after="20" padding-start="50" background-image="/Users/Richard/documents/workspace-copy/miroserver3/web/miro/images/U1.png">
					<xsl:apply-templates />
				</fo:block>
			</fo:flow>
		</fo:page-sequence>
		...
		<fo:page-sequence  master-reference="A4"  >
			...
			<fo:static-content flow-name="xsl-region-before">
				...
				<fo:block border-bottom-width="0.25mm" border-bottom-style="solid">
						<fo:external-graphic src="url('/opt/tomcat5/webapps/mirotest/miro/images/miro-logo.jpg')" content-height="35px"  content-width="75px"/>
				</fo:block>
			</fo:static-content>
			−
			...
			Copyright &#169; MiRo Psychometrics Ltd 2008
		</fo:block>
