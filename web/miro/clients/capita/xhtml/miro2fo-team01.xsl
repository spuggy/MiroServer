...
<xsl:stylesheet version="1.0"
		...
		<fo:root>
			<fo:layout-master-set>
				<fo:simple-page-master master-name="noheader" page-height="29.7cm" page-width="21.0cm" margin-left="0cm" margin-right="0.0cm">
					<fo:region-body  background-image="/home/webadmin/miro-assessment.com/miro-reports/images/miroteamreport/homepage02.png"/>
	...
	<xsl:template match="/html/body/div[@id &gt; '0' ]">
		<fo:page-sequence  master-reference="A4"  >
			    ...
			    <fo:static-content flow-name="xsl-region-before">
						...
						<fo:external-graphic src="url('/home/webadmin/miro-assessment.com/miro-reports/images/miroteamreport/header_logo.png')" content-height="35px"  content-width="450px"/>
				</fo:block>
			</fo:static-content>
			<fo:static-content flow-name="xsl-region-after" >
				<fo:block text-align="center" font-size="10pt" line-height="12pt" space-after="10pt"  border-top-width="0.25mm" border-top-style="solid" >
					<fo:page-number />
	...
	<xsl:template match="p">
		<fo:block text-align="justify" font-size="10pt" line-height="12pt" space-after="10pt">
			<xsl:apply-templates select="*|text()" />
		</fo:block>
	</xsl:template>
