function BTL_popUpWindow(URL) {

window.open(URL,'_blank','toolbar=no,status=no,scrollbars=no,location=no,menubar=no,directories=no,top=200,left=200,width=586,height=400');
