    ...
    <div class="col-sm-8">
        <c:set var="buttons">
            <button class="btn btn-primary" onclick="location.href='<c:url
                    value="/editUser.html?method=Add&from=list"/>'"><fmt:message key="button.add"/></button>
...
<div class="row">
    <div id="miro-content" class="col-sm-8">
        ...
        <display:table name="userList" cellspacing="0" cellpadding="0" requestURI="" defaultsort="1" id="users" pagesize="1000" class="table table-condensed table-hover" export="false">
